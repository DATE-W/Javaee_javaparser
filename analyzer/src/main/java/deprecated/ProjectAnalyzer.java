...
//    private final List<File> javaFiles; // 存储项目中的 Java 文件列表
//    private String packageName; // 项目的包名
//    public static JavaParser CONFIGURED_PARSER; // 已配置的 JavaParser 实例
//    public CallGraph graph = new CallGraph(); // 调用关系图
//
//    // 构造函数，初始化分析器并配置 JavaParser
